...
- Campo de buscar para pesquisar filme;
- Campo para inserir o ID de usuário;
- Botão para pesquisar o ID de usuário;
- Botão para compartilhar favoritos, se houver filme favorito será gerado um link, caso não haja um filme salvo como favorito,
- um alerta é emitido informando que não há favoritos disponíveis;
- Botão para Atualizar Lista, serve como refresh para exibição da listagem de filmes;
...
- Compile o projeto;
- De acordo com o endpoint, preencha com um ID e depois vá em execute;
- Os resultados serão exibidos em formato JSON;

# Como testar o Front-end?
- Primeiro compile o projeto Back-end e mantenha-o aberto;
- Volte ao Visual Studio;
- Clique com o botão direito na pasta ratingfrontend;
- Clique em "open in terminal";
...
LinkedIn: https://www.linkedin.com/in/alan-s-5866a619a/
